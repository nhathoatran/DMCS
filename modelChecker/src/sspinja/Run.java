...
//	public static SchedulerCTLGenSearch genAlgo = null ;
	private HeuristicSearch algoHeur  = null ;
	private SchedulerOptimizeSearch algoSchOpt  = null ;
	private SchedulerDepthFirstSearch algoSchDepth  = null ;
...
//	private LivenessHeuristicSearch ahlive = null ;
	...
	public Run(int searchOption) {
		...
		//	case 7: //for heuristic
		//	case 8: //liveness check
		//	case 9 : //liveness check with heuristic
		//	case 10 :SchedulerCTLGenSearch
		//	case 11: SchedulerMulticoreCTLGenSearch
...
//		Log.flushOutputTest();
	...
	public void search(final Class<? extends PromelaModel> clazz) {
		...
		if (model instanceof SchedulerPanOptimizeModel) {
			Config.isCompileSchedulerOptimize = true;
		}
		if (model instanceof SchedulerPromelaModel) {
			...
			try {
				...
				if (model instanceof SchedulerSporadicModel) {
					...
					if (model instanceof SchedulerPanOptimizeModel){
						SchedulerPromelaModel.panmodel = (SchedulerPanOptimizeModel) model ;					
					} else {
		...
		//6SchedulerDepthFirstSearch
		//searchOption = 8 ; //8heuristic
		//	case 0: //DFS
		//	case 1: //Heuristic
		...
		case 1 : //Heuristic
			maxError = 1 ;			
			//algoHeur = new HeuristicSearch(PanOptimizeModel model);	
			algoHeur = new HeuristicSearch((PanOptimizeModel) model);
			break ;
/*	case 1 :
...
*/
		case 6:
			algo = new SchedulerDepthFirstSearch<ConcurrentModel<PromelaTransition>, PromelaTransition>(
			model, store, maxDepth = 1000
			, errorExceedDepth.isSet(), !ignoreInvalidEnd.isSet(),
			nrErrors.getValue(), nextTransition);
			break ;
			
		case 8 :
			algo = new SchedulerOptimizeSearch<ConcurrentModel<PromelaTransition>, PromelaTransition>(
					model, store, maxDepth
					, errorExceedDepth.isSet(), !ignoreInvalidEnd.isSet(),
					nrErrors.getValue(), nextTransition);
								
			System.out.println("HeuristicSearch");
			break ;
//		case 8 :
...
//		case 10:
//			maxError = 0 ;
//			algo = new SchedulerCTLGenSearch<ConcurrentModel<PromelaTransition>, PromelaTransition>(
//					model, store, maxDepth
//					, errorExceedDepth.isSet(), !ignoreInvalidEnd.isSet(),
//					maxError, nextTransition);
////			Config.isCheckAcceptionCycle = false ;
//			genAlgo = (SchedulerCTLGenSearch) algo ;
//			System.out.println("Scheduler CTL Genenerate Depth First Search");
//			Log.out.println("Scheduler CTL Genenerate Depth First Search");
//			break ;	
//		case 11:
//			maxError = 0 ;
//			algo = new SchedulerMulticoreCTLGenSearch<ConcurrentModel<PromelaTransition>, PromelaTransition>(
//					model, store, maxDepth
//					, errorExceedDepth.isSet(), !ignoreInvalidEnd.isSet(),
//					maxError, nextTransition);
////			Config.isCheckAcceptionCycle = false ;
//			//genAlgo = (SchedulerCTLGenSearch) algo ;
//			System.out.println("Scheduler SchedulerMulticoreCTLGenSearch");
//			Log.out.println("Scheduler SchedulerMulticoreCTLGenSearch");
//			break ;
//	
		}
		maxDepth = 1000;
