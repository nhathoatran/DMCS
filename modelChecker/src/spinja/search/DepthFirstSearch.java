...
//	public static PanModel panmodel ;
...
//			System.out.println("- (stack.pop()). Undoing transition: " + stack.getLastTransition());
//			System.out.println("-> ID:" + stack.getTopIdentifer());
			stack.getLastTransition().undo();
//			System.out.println("- Last transition: " + stack.getLastTransition());
//			if (stack.getLastTransition().toString().contains("_nr_pr")) {
...
//	protected void takeTransition(Transition next, int from, int to) throws SpinJaException {
//		takeTransition(next);
//		System.out.println("- " + from + " -> " + to + " : " + next);
//	};
...
//		System.out.println("- Undoing transition: " + stack.getLastTransition());
		stack.getLastTransition().undo();
	}
